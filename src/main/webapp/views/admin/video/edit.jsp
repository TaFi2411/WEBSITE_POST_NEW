...
<body>
    ...
    <!-- Nội dung -->
    <div class="content">
        <h2 class="text-primary">Chỉnh sửa Tin Tức</h2>
        ...
        <div class="card">
            <form action="/TaiLT_PC09570_ASM2/admin/video/update" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <span class="text-danger">${erImage}</span>
                </div>

                <div class="mb-3">
                    <label class="form-label">Mô tả:</label>
                    <textarea class="form-control" name="description" rows="6">${video.description}</textarea>
                    <span class="text-danger">${erDcrt}</span>
                </div>
                ...
                <button class="btn btn-submit" id="tngluutintucupdate"><i class="fa-solid fa-save"></i> Lưu Tin Tức</button>
            </form>
        </div>
    </div>
