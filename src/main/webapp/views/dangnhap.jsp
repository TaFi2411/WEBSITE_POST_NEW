...
<body>
    ...
    <div class="login-container">
        ...
        <form action="/TaiLT_PC09570_ASM2/dang-nhap" method="post">
            <div class="mb-3">
                <label class="form-label"><i class="fa-solid fa-envelope"></i> Email:</label>
                <input type="text" class="form-control" name="email" placeholder="Nhập email của bạn" value="${loginInput.email}">
                <span class="text-danger" id="eremail">${eremail}</span>
                <span class="text-danger" id="ertk">${ertk}</span>
            </div>
            ...
            <div class="mb-3">
                ...
                <span class="text-danger" id="erpwnull">${erpwnull}</span>
                <span class="text-danger" id="erpw">${erpw}</span>
                
            </div>

            <button id="testdangnhap" class="btn btn-login"><i class="fa-solid fa-sign-in-alt"></i> Đăng Nhập</button>
            ...
            <div class="register-link">
                <span class="text-dark">Chưa có tài khoản?</span> <a href="dang-ky">Đăng ký ngay</a>
            </div>
        </form>
    </div>
